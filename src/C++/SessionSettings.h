...
const char SQLITE_STORE_DATABASE[] = "SQLiteStoreDatabase";
...
const char SQLITE_LOG_DATABASE[] = "SQLiteLogDatabase";
const char SQLITE_LOG_INCOMING_TABLE[] = "SQLiteLogIncomingTable";
const char SQLITE_LOG_OUTGOING_TABLE[] = "SQLiteLogOutgoingTable";
const char SQLITE_LOG_EVENT_TABLE[] = "SQLiteLogEventTable";
