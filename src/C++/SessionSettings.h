...
const char SQLITE_LOG_DATABASE[] = "MySQLLogDatabase";
const char SQLITE_LOG_INCOMING_TABLE[] = "MySQLLogIncomingTable";
const char SQLITE_LOG_OUTGOING_TABLE[] = "MySQLLogOutgoingTable";
const char SQLITE_LOG_EVENT_TABLE[] = "MySQLLogEventTable";
